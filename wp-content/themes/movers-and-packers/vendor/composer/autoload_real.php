...
class Movers_And_Packers_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function movers_and_packers_loadClassLoader($class)
    {
    ...
    public static function movers_and_packers_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
