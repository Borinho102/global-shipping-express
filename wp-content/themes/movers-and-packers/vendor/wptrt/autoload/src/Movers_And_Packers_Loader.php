...
class Movers_And_Packers_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function movers_and_packers_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function movers_and_packers_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function movers_and_packers_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function movers_and_packers_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->movers_and_packers_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function movers_and_packers_load( $class ) {
