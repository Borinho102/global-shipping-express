...
= 0.6.2 =
* Resolved error of overlapping serv sec when slider is off.
...
* Check padding of toggle button in responsive. 
* Checked submenu.
...
* Added go pro button in slider, footer, services and about section in customizer.
* Updated language folder.
...
* Added post date, author, comments & time icon option in customizer.
...
* Resolved css error for about section.
* Update language folder.
...
VW Transport Cargo WordPress Theme, Copyright 2018 VWthemes
VW Transport Cargo is distributed under the terms of the GNU GPL.
...
* Asap *
* Source : https://fonts.google.com/specimen/Asap?query=Asap

*  Stocksnap Images
   License: CC0 1.0 Universal (CC0 1.0) 
   Source: https://stocksnap.io/license

   Slider Image, Copyright Jay Mantri
   License: CC0 1.0 Universal (CC0 1.0)
   Source: https://stocksnap.io/photo/3148453E5E

   About Image, Copyright Freestocks.org
   License: CC0 1.0 Universal (CC0 1.0)
   Source: https://stocksnap.io/photo/6FL15NRGIR

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://www.vwthemesdemo.com/docs/free-vw-transport-cargo/