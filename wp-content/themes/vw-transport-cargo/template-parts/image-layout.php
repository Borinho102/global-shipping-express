        ...
        <div class="entry-attachment">
            ...
            <?php if ( has_excerpt() ) : ?>
                <div class="entry-caption">
                    <div class="entry-content"><p><?php $vw_transport_cargo_excerpt = get_the_excerpt(); echo esc_html( vw_transport_cargo_string_limit_words( $vw_transport_cargo_excerpt, esc_attr(get_theme_mod('vw_transport_cargo_excerpt_number','30')))); ?></p></div>
                </div>
            <?php endif; ?>
        </div>    
        <?php
