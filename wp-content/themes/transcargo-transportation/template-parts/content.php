...
<div class="col-lg-6 col-md-6 col-sm-6">
  <div id="post-<?php the_ID(); ?>" <?php post_class('post-box mb-4 p-3'); ?>>
    ...
    <div class="post-meta my-3">
      ...
      <span class="ml-3"><i class="far fa-comments mr-2"></i> <?php comments_number( esc_attr('0', 'transcargo-transportation'), esc_attr('0', 'transcargo-transportation'), esc_attr('%', 'transcargo-transportation') ); ?> <?php esc_html_e('comments','transcargo-transportation'); ?></span>
    </div>
    <h3 class="post-title mb-3 mt-0"><a href="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php the_title(); ?></a></h3>
    <div class="post-content">
      <?php echo wp_trim_words( get_the_content(), get_theme_mod('transcargo_transportation_post_excerpt_number',15) ); ?>
    </div>
  </div>
</div>