...
?>
<?php $icon1 = get_theme_mod( 'transcargo_transportation_dashicons_setting_1', 'dashicons dashicons-phone' ); ?>
<?php $icon2 = get_theme_mod( 'transcargo_transportation_dashicons_setting_2', 'dashicons dashicons-email' ); ?>
<?php $icon3 = get_theme_mod( 'transcargo_transportation_dashicons_setting_3', 'dashicons dashicons-clock' ); ?>

<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'transcargo-transportation' ); ?></a>

<?php if ( get_theme_mod('transcargo_transportation_site_loader', false) == true ) : ?>
	<div class="cssloader">
    	<div class="sh1"></div>
    	<div class="sh2"></div>
		...
		<div class="row mb-md-3 mb-lg-0">
				    ...
				    <div class="logo-content">
				    	<?php
				    		if ( get_theme_mod('transcargo_transportation_display_header_title', true) == true ) :
					      	...
					      	if ( get_theme_mod('transcargo_transportation_display_header_text', true) == true ) :
		    ...
		    <div class="col-lg-3 col-md-4 align-self-center">
		    	<?php if ( get_theme_mod('transcargo_transportation_header_phone_number') ) : ?>
			    	<p class="mb-0"><span class="dashicons dashicons-<?php echo esc_attr( $icon1 ); ?>"></span><?php esc_html_e('Call Us : ','transcargo-transportation'); ?><?php echo esc_html( get_theme_mod('transcargo_transportation_header_phone_number' ) ); ?></p>
			  	<?php endif; ?>
		    </div>
		    <div class="col-lg-3 col-md-4 align-self-center">
		    	<?php if ( get_theme_mod('transcargo_transportation_header_email_address') ) : ?>
			    	<p class="mb-0"><span class="dashicons dashicons-<?php echo esc_attr( $icon2 ); ?>"></span><?php esc_html_e('Send Us Email : ','transcargo-transportation'); ?><?php echo esc_html( get_theme_mod('transcargo_transportation_header_email_address' ) ); ?></p>
			  	<?php endif; ?>
		    </div>
		    <div class="col-lg-3 col-md-4 align-self-center">
		    	<?php if ( get_theme_mod('transcargo_transportation_header_open_timings') ) : ?>
			    	<p class="mb-0"><span class="dashicons dashicons-<?php echo esc_attr( $icon3 ); ?>"></span><?php esc_html_e('Timings : ','transcargo-transportation'); ?><?php echo esc_html( get_theme_mod('transcargo_transportation_header_open_timings' ) ); ?></p>
			  	<?php endif; ?>
		    </div>
		</div>
	</div>
			...
			<div class="row menu-bg-box">
				<div class="col-lg-8 col-md-8 col-12 align-self-center">
					<button class="menu-toggle my-2 p-2" aria-controls="top-menu" aria-expanded="false" type="button">
						<span aria-hidden="true"><?php esc_html_e( 'Menu', 'transcargo-transportation' ); ?></span>
					</button>
