...
Transportation Shipment is distributed under the terms of the GNU General Public License v3.0 or later
...
= 1.0.1 =
* Resolved css error in media query.
* Added condition for slider image.

= 1.0.2 =
* Resolved css error in product section.

= 1.0.3 =
* Added Block pattern in theme.

= 1.0.4 =
* Resolved css error in about section.

= 1.0.5 =
* Resolved css error of single post.
...
* Added copyright text footer credit link option in functions.php.

= 1.0.7 =
* Resolved css error for slider button border radius.

= 1.0.8 =
* Resolved css error topbar menu hover color.

= 1.0.9 =
* Resolved css error of topbar search icon hover color.

= 1.1 =
* Resolved css for single post bradcrumbs anchor color,anchor bg color.
* Resolved css for single post bradcrumbs span color,span bg color.

= 1.1.1 =
* Added condition for show/hide slider button option in responsive media.
...
* Added condition for show /hide copyright option.
* Added condition for show /hide footer option.

= 1.1.4 =
* Resolved css error for services section.
* Resolved css error for slider content.

= 1.1.5 =
* Resolved css error for sidebar product search.

= 1.1.6 =
* Resolved css error for metabox.

= 1.1.7 =
* Resolved css error for woocommerce product search button.
* Resolved css error for service section.
* Tested upto WP v6.3

= 1.1.8 =
* Resolved error for slider image.
* Resolved menu condition issues.

= 1.1.9 =
* Resolved css error for submenu bg color.
* Resolved css error for footer calender anchor.

= 1.2 =
* Resolved css error for tag cloud hover bg colors.
* Resolved css error for search button bg colors.
* Resolved css error for block buttons bg colors.
* Resolved css error for sidebar headings colors.
...
Source: https://pxhere.com/en/photo/592606