...
function warehouse_cargo_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Woocommerce Shop Page Sidebar', 'warehouse-cargo' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Woocommerce Single Product Page Sidebar', 'warehouse-cargo' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 1', 'warehouse-cargo' ),
		'id'            => 'warehouse-cargo-footer1',
		'description'   => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 2', 'warehouse-cargo' ),
		'id'            => 'warehouse-cargo-footer2',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h5 class="footer-column-widget-title">',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 3', 'warehouse-cargo' ),
		'id'            => 'warehouse-cargo-footer3',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h5 class="footer-column-widget-title">',
...
function warehouse_cargo_scripts() {
	...
	wp_add_inline_style( 'warehouse-cargo-style',$warehouse_cargo_theme_css );

	wp_style_add_data('warehouse-cargo-basic-style', 'rtl', 'replace');

	// fontawesome
	wp_enqueue_style( 'fontawesome-style',get_template_directory_uri().'/assets/css/fontawesome/css/all.css' );

    wp_enqueue_script('warehouse-cargo-theme-js',get_template_directory_uri() . '/assets/js/theme-script.js', array('jquery'), '', true );
...
function warehouse_cargo_theme_color() {
    ...
    $warehouse_cargo_theme_color_css = '';
    ...
    $warehouse_cargo_logo_max_height = get_theme_mod('warehouse_cargo_logo_max_height');

  	if(get_theme_mod('warehouse_cargo_logo_max_height') == '') {
		$warehouse_cargo_logo_max_height = '24';
	}
	...
	$warehouse_cargo_theme_color_css = '
		.custom-logo-link img{
			max-height: '.esc_attr($warehouse_cargo_logo_max_height).'px;
	 	}
	...
	';
    wp_add_inline_style( 'warehouse-cargo-style',$warehouse_cargo_theme_color_css );
...
//SELECT
function warehouse_cargo_sanitize_select( $input, $setting ){
    $input = sanitize_key($input);
    $choices = $setting->manager->get_control( $setting->id )->choices;
    return ( array_key_exists( $input, $choices ) ? $input : $setting->default );
}

function warehouse_cargo_sanitize_number_absint( $number, $setting ) {
...
function warehouse_cargo_page_redirection() {
	global $pagenow;
		if (isset($_GET['activated']) && ('themes.php' == $pagenow) && is_admin()) {
		wp_safe_redirect(admin_url("themes.php?page=warehouse-cargo-info.php"));
	}
}
add_action('after_setup_theme', 'warehouse_cargo_page_redirection');
