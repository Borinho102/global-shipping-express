        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-4 col-9 align-self-center">
                <div class="navbar-brand">
                    ...
                    <?php endif; ?>
                    <?php $warehouse_cargo_blog_info = get_bloginfo( 'name' ); ?>
                        <?php if ( ! empty( $warehouse_cargo_blog_info ) ) : ?>
                        ...
                        <?php endif; ?>
                        <?php
                            $warehouse_cargo_description = get_bloginfo( 'description', 'display' );
                            if ( $warehouse_cargo_description || is_customize_preview() ) :
                        ?>
                        <?php if( get_theme_mod('warehouse_cargo_theme_description',false) != ''){ ?>
                         <p class="site-description"><?php echo esc_html($warehouse_cargo_description); ?></p>
                        <?php }?>
                    <?php endif; ?>
                </div>
            </div>
