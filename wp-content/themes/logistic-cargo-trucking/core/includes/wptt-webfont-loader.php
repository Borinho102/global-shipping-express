...
if ( ! class_exists( 'Logistic_Cargo_Trucking_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Logistic_Cargo_Trucking_WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $logistic_cargo_trucking_css;
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Logistic_Cargo_Trucking_WPTT_WebFont_Loader( $url );
