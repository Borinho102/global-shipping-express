...
function transport_lite_setup() {		
	$GLOBALS['content_width'] = apply_filters( 'transport_lite_content_width', 680 );		
...
define('TRANSPORT_LITE_THEME_DOC',__('https://gracethemes.com/documentation/transport/#homepage-lite','transport-lite'));
define('TRANSPORT_LITE_PROTHEME_URL',__('https://gracethemes.com/themes/transport-wordpress-theme/','transport-lite'));
define('TRANSPORT_LITE_LIVE_DEMO',__('https://gracethemes.com/demo/transport/','transport-lite'));
 ...
 */
add_action( 'after_setup_theme', 'transport_lite_setup_woocommerce_support' );
function transport_lite_setup_woocommerce_support()   
{
 ...
 */
function transport_lite_skip_link_focus_fix() {  
...
add_action( 'wp_print_footer_scripts', 'transport_lite_skip_link_focus_fix' );