=== Logistic Transport WordPress Theme ===
...
* Changed header images dimensions & added some css.
...
* Removed margin of copyright text.
...
= 0.6.7 =
* Added option to change services Button text.
* Added about content Excerpt Length option.
* Updated all .po files.
...
* Resolved css error from cart page.
* Added get started.
* Updated .pot file.
...
= 0.8.2 =
* Resolved css error in WooCommerce pages.
...
= 0.8.5 =
* Added Enable / Disable Single Post Author option.
* Updated .pot file.
...
* Resolved css error for slider image.

= 0.9.6 =
* Resolved css error for slider image.
* Resolved css error for product section.
...
= 0.9.8 =
* Resolved css error for slider button border radius.
...
* Resolved css error for responsive media slider content.
* Update POT file.

= 1.0.2 =
* Resolved error for show/hide topbar option.
...
* Resolved css error for related posts in responsive media.
...
* Resolved css error for sidebar product search.
* Update POT file.
...
* Tested upto WP v6.3
* Resolved css error for service section.
* Resolved css error for carousel content in tablet media.
* Resolved css error for post navigation button.
...
* Resolved error for global colors.

= 1.1.1 =
* Added blog post date icon,author icon,comment icon,time icon option.
* Resolved css error for sidebar search.
* update pot file.
...
Logistic Transport is distributed under the terms of the GNU GPL
...
- Stocksnap Images
	...
	Header Image, Copyright Markus Spiske
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/M3RGNMTIDG
